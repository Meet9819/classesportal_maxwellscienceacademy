					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
									...
									/* code for data delete */
											...
											$result = mysqli_query($con,"SELECT * from blogs order by id"); 
											...
											echo '
												...
												<tr>
                                                    ...
                                                    <?php echo '<td style="width:5%"><img style="width:50px" src="../images/blogs/'.$row['img'].'"> <br>'.$row['img'].'</td>
												...
												<?php echo '
												  ...
												  <a href="blogsedit.php?edit_id='.$row['id'].'">
