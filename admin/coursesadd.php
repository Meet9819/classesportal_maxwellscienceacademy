...
$result = mysqli_query($con, "SELECT * FROM courses ORDER BY id DESC LIMIT 1");
...
?>
						...
						<form class="form-horizontal" action="coursesupload.php" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							<div class="form-group">
  							...
  							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" name="fees" class="form-control" id="eleven" placeholder="Enter Product Price ..." >
								</div>
