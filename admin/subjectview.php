		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View subject</h4>
					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
									...
									if(isset($_GET['del']))
									{
									    ...
									    $SQL = mysqli_query($con,"DELETE FROM subject WHERE id=".$_GET['del']);
									...
									/* code for data delete */
											...
											$result = mysqli_query($con,"SELECT c.title, s.subjectname, s.id FROM `subject` s, `courses` c where s.courseid = c.id"); 
											...
											echo '
												...
												<?php echo '
												  ...
												  <a href="subjectedit.php?edit_id='.$row['id'].'">
