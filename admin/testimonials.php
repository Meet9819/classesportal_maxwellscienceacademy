...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"],"../images/testimonials/" . $_FILES["image"]["name"]);

            $img="" . $_FILES["image"]["name"];
			 $post = $_POST['post']; $name = $_POST['name'];
			  $message = $_POST['message'];
            $save=mysqli_query($con,"INSERT INTO slider (name,img, post,message) VALUES ('$name','$img','$post','$message')");
...
?>
 							 <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="form-group">
									...
									<p class="help-block">Image should be 600 x 500 in pixels</p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" type="text" id="" name="post" required="">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" type="text" id="" name="message" required="">
					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						<thead>
							<tr>
								...
								<th>Image</th><th>Name</th><th>Message</th>
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:50px" src="../images/testimonials/'.$row['img'].'"></td>
								
									<td>'.$row['name'].'    </td>												
									<td>'.substr($row['message'],0,180).'..    </td>											
									<td>
