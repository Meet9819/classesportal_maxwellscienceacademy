...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT name,img FROM client WHERE id =:id');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if($imgFile)
        {
            $upload_dir = '../images/clients/'; // upload directory 
        ...
        if(!isset($errMSG))
        {
$stmt = $DB_con->prepare('UPDATE client SET name=:name,  img=:img
    WHERE id=:id');
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									  ...
									  <img src="../images/clients/<?php echo $img; ?>" height="70" width="150" />
