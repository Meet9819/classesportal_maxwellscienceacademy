		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View courses</h4>
					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
									...
									if(isset($_GET['del']))
									{
									    ...
									    $SQL = mysqli_query($con,"DELETE FROM courses WHERE id=".$_GET['del']);
									...
									/* code for data delete */
											...
											$result = mysqli_query($con,"SELECT * from courses order by id"); 
											...
											echo '
												...
												<tr>
                                                    ...
                                                    <?php echo '<td style="width:5%"><img style="width:50px" src="../images/courses/'.$row['img'].'"> <br>'.$row['img'].'</td>
													<td style="width:5%">'.$row['title'].'</td> 
													<td>'.substr($row['shortdescription'],0,180).'..     </td>												
													<td>'.substr($row['longdescription'],0,180).'..    </td>
													<td>&#8377;'.$row['fees'].'</td>   	
												...
												<?php echo '
												  ...
												  <a href="coursesedit.php?edit_id='.$row['id'].'">
