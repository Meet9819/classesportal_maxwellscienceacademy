...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT img,title,shortdescription FROM slider WHERE id =:id');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if(!isset($errMSG))
        {
$stmt = $DB_con->prepare('UPDATE slider SET img=:img, title =:title, shortdescription=:shortdescription
    WHERE id=:id');
...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<img src="../images/slider/<?php echo $img; ?>" height="70" width="150" />
								...
								<p class="help-block">Image should be 1920 x 755 in pixels</p>
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="" name="title" value="<?php echo $title; ?>" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="" name="shortdescription" value="<?php echo $shortdescription; ?>" required="">
