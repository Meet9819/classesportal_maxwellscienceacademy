...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT  title, fees,shortdescription,longdescription, img FROM courses WHERE id =:id');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        { 
            ...
            $upload_dir = '../images/courses/'; // upload directory 
...
$stmt = $DB_con->prepare('UPDATE courses SET  title=:title,  img=:img,  fees=:fees, shortdescription=:shortdescription, longdescription=:longdescription, fees=:fees
    WHERE id=:id');
...
?>
					...
					<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								<label for="one" class="col-sm-3 control-label">Courses Name</label>
								<div class="col-sm-3">
									<input type="text" name="title" class="form-control" id="one" placeholder="Enter Courses Name..." value="<?php echo $title; ?>" required="">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
								<textarea class="form-control" name="shortdescription" id="shortdescription" placeholder="Write your Product Description" required=""><?php echo $shortdescription; ?></textarea>  
                            ...
                            <div class="form-group">
                                  <label for="eleven" class="col-sm-3 control-label"> fees</label>
                                <div class="col-sm-3">
                                    <input type="number" name="fees" class="form-control" id="eleven" placeholder="Enter   fees ..." value="<?php echo $fees; ?>" required="">
                                </div>
