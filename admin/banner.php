...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            $save=mysqli_query($con,"INSERT INTO slider (img, title,shortdescription) VALUES ('$img','$title','$shortdescription')");
...
?>
 							 <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" type="text" id="" name="shortdescription" required="">
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:200px" src="../images/slider/'.$row['img'].'"></td>
