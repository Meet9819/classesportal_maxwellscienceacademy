		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View topic</h4>
					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
									...
									if(isset($_GET['del']))
									{
									    ...
									    $SQL = mysqli_query($con,"DELETE FROM topics WHERE id=".$_GET['del']);
									...
									/* code for data delete */
											...
											$result = mysqli_query($con,"SELECT t.id, t.topicname, c.chaptername FROM `topics` t, `chapter` c where t.chapterid = c.id");  
											...
											echo '					
												...
												<?php echo '
												  ...
												  <a href="topicedit.php?edit_id='.$row['id'].'">
