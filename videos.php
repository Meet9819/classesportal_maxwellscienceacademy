    	...
    	<div class="row align-items-center">
        	<div class="col-sm-6">
            	<div class="page-title">
            		<h1>Our Free Videos and Notes</h1>
                </div>
            </div>
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-sm-end">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Free Videos and Notes</li>
                  </ol>
                </nav>
            </div>
        </div>
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="freevideos" role="tabpanel" aria-labelledby="freevideos-tab1">
                               <div class="border radius_all_5 tab_box"> 
                                  ...
                                  <div class="container">
                                    ...
                                    <?php include('db.php');
                                     $result = mysqli_query($con,"SELECT * from videos where  type = 'FREE' and whichformat = 'VIDEOS'");
                            ...
                            <div class="tab-pane fade" id="freenotes" role="tabpanel" aria-labelledby="freenotes-tab1">
                              ...
                              <?php include('db.php');
                                     $result = mysqli_query($con,"SELECT * from videos where  type = 'FREE'  and whichformat = 'NOTES'");
                                     while($row = mysqli_fetch_array($result))
                                     {
                                    echo '  
                            ...
                            <div class="tab-pane fade" id="paidvideos" role="tabpanel" aria-labelledby="paidvideos-tab1">
                                ...
                                <div class="container">
                                    ...
                                    <?php include('db.php');
                                     $result = mysqli_query($con,"SELECT * from videos where  type = 'PAID'  and whichformat = 'VIDEOS'");
                                     while($row = mysqli_fetch_array($result))
                                     {
                                    echo '  
                            ...
                            <div class="tab-pane fade" id="paidnotes" role="tabpanel" aria-labelledby="paidnotes-tab1">
                                <div id="accordion" class="accordion">
                                    ...
                                    <?php include('db.php');
                                     $result = mysqli_query($con,"SELECT * from videos where  type = 'PAID'  and whichformat = 'NOTES'");
                                     while($row = mysqli_fetch_array($result))
                                     {
                                    echo '  
